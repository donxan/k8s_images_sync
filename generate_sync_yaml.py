...
def get_repo_aliyun_tags(image):
    ...
    token_url = "https://dockerauth.cn-hangzhou.aliyuncs.com/auth?scope=repository:k8sgco/{image}:pull&service=registry.aliyuncs.com:cn-hangzhou:26842".format(
        image=image_name)
    try:
    ...
    tag_url = "https://registry.cn-hangzhou.aliyuncs.com/v2/k8sgco/{image}/tags/list".format(image=image_name)
